    ...
    for patient in tqdm(os.listdir(test_path)): 
        ...
        with torch.no_grad():
            for batch_idx, sample in enumerate(test_loader):     
                ...
                output_ensamble[0,1,:,:] = (0.81 * output_1[0,1,:,:] + 0.72 * output_2[0,1,:,:] + 0.78 * output_3[0,1,:,:] + 0.83 * output_4[0,1,:,:])/3.15
                output_ensamble[0,2,:,:] = (0.72 * output_1[0,2,:,:] + 0.93 * output_2[0,2,:,:] + 0.92 * output_3[0,2,:,:] + 0.93 * output_4[0,2,:,:])/3.45
                output_ensamble[0,3,:,:] = (0.80 * output_1[0,3,:,:] + 0.79 * output_2[0,3,:,:] + 0.91 * output_3[0,3,:,:] + 0.90 * output_4[0,3,:,:])/3.39
                output_ensamble[0,4,:,:] = (0.91 * output_1[0,4,:,:] + 0.91 * output_2[0,4,:,:] + 0.91 * output_3[0,4,:,:] + 0.91 * output_4[0,4,:,:])/3.64
